...
public class ChatServerThread extends Thread {
                ...
                switch (input.toLowerCase()) {
                    ...
                    case ("send image"):
                        if (pickedPartner != null) {
                            server.sendTo(pickedPartner, "sending image");
                            server.sendBytesTo(pickedPartner, streamIn.readAllBytes());
                        }
                        break;
                    default:
                        if (pickedPartner != null) {
    ...
    public void sendBytesTo(byte[] bytes) {
        try {
            ...
            System.out.println("Unexpected exception while forwarding image: " + ioe.getMessage());
        }
    }
}
